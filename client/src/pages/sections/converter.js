  ...
  return (
    <div className="w-full px-9">
      ...
      <div className="my-5 flex space-x-7 justify-center">
        <div
          className="bg-[#4cd82580] rounded-full w-12 h-12 flex justify-center items-center active:scale-110 active:shadow-2xl transition-all duration-500"
          onClick={() => {
            controller.swapConversion();
